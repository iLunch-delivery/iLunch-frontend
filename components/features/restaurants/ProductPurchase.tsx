...
import { faMoneyCheckDollar, faHashtag, faPencil, faXmark } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className='flex justify-between'>
        ...
        <div className='space-y-4'>
          <div className='space-y-0.5'>
            ...
            <div className='flex items-center'>
              ...
              <p className='inline px-2 text-xs text-slate-500 font-semibold'>COP ${price.toLocaleString('es')}</p>
            </div>
            <div className='flex items-center'>
              <FontAwesomeIcon icon={faHashtag} style={{color: "#808080",}} />
              <p className='inline px-2 text-xs text-slate-500 font-semibold'>x{amount} unidades</p>
            </div>
          </div>
        </div>
      </div>
      <div className='flex basis-16 items-center justify-around'>
        <button className='hover:scale-125'>
          <FontAwesomeIcon icon={faPencil} size='lg' style={{color: "#808080",}} />
        </button>
        <button className='hover:scale-125'>
          <FontAwesomeIcon icon={faXmark} size='lg' style={{color: "#808080",}} />
        </button>
      </div>
    </div>
  )
