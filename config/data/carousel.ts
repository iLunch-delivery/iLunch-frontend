...
export const categoryCarousel = [
  ...
  [
    { url: '/assets/category_icons/category(1).png', title: 'Category 6' },
    { url: '/assets/category_icons/category(2).png', title: 'Category 7' },
    { url: '/assets/category_icons/category(3).png', title: 'Category 8' },
    { url: '/assets/category_icons/category(4).png', title: 'Category 9' },
    { url: '/assets/category_icons/category(5).png', title: 'Category 10' }
  ]
]
