                ...
                <section className='grid md:grid-cols-2 gap-12'>
                    <section>
                        <div id='purchaseSummary'>
                            <h2 className='text-2xl font-semibold'>Resultados de tu busqueda</h2>
                    ...
                    <section>
                        <div id='recommended-section' className='my-4'>
                            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginBottom: '45px' }}>
                                <div style={{ marginBottom: '35px', display: 'flex', justifyContent: 'center' }}>
                                    <h2 className='text-2xl font-semibold'>El destacado de la semana</h2>
                                </div>
                                <button style={{ background: 'none', border: 'none', marginBlockEnd: '20px' }}>
